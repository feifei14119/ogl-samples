...
layout(binding = 0) uniform image2D Diffuse[3];
...
// TODO: need an extension to allowed passing qualifiers on the function parameters
vec4 fetchBilinear(image2D Image, in vec2 Interpolant, in ivec2 Texelcoords[4])
{
...
vec4 imageBilinear(image2D Image, in vec2 Texcoord)
{
